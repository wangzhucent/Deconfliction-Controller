...
%% Agent4
agent4.q_start.coord = [20  205];
agent4.q_start.dir=0; 
agent4.q_start.cost = 0;
agent4.q_start.parent = 0;

agent4.q_goal.coord = [460 235];
...
set(gcf,'unit','normalized','position',[0.2 0.2 0.25 0.5])
...
%% make video
writerObj=VideoWriter('simulation3.avi');
